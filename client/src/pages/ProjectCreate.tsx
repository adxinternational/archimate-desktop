...
const PHASE_LABELS: Record<string, string> = {
  ...
  det: "DET — Direction Exécution Travaux",
  aor: "AOR — Assistance Opérations Réception",
};
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <CardContent className="space-y-4">
              <FormField control={form.control} name="name" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl><Input placeholder="Ex: Villa Dupont - Réhabilitation" {...field} /></FormControl>
                  <FormMessage />
                </FormItem>
              )} />
              ...
              <div className="grid grid-cols-2 gap-4">
                <FormField control={form.control} name="address" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl><Input placeholder="Adresse du projet" {...field} /></FormControl>
                    <FormMessage />
                  </FormItem>
                )} />
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <FormField control={form.control} name="budgetEstimated" render={({ field }) => (
                  <FormItem>
          ...
          <div className="flex gap-3 mt-6 justify-end">
            <Link href="/projects"><Button type="button" variant="outline">Annuler</Button></Link>
