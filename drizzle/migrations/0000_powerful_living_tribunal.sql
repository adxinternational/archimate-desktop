...
ALTER TABLE `cost_estimates` ADD CONSTRAINT `cost_estimates_projectId_projects_id_fk` FOREIGN KEY (`projectId`) REFERENCES `projects`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `exchange_history` ADD CONSTRAINT `exchange_history_clientId_clients_id_fk` FOREIGN KEY (`clientId`) REFERENCES `clients`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `exchange_history` ADD CONSTRAINT `exchange_history_leadId_leads_id_fk` FOREIGN KEY (`leadId`) REFERENCES `leads`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `gantt_tasks` ADD CONSTRAINT `gantt_tasks_projectId_projects_id_fk` FOREIGN KEY (`projectId`) REFERENCES `projects`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `gantt_tasks` ADD CONSTRAINT `gantt_tasks_siteId_construction_sites_id_fk` FOREIGN KEY (`siteId`) REFERENCES `construction_sites`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `meeting_reports` ADD CONSTRAINT `meeting_reports_projectId_projects_id_fk` FOREIGN KEY (`projectId`) REFERENCES `projects`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `phase_checklists` ADD CONSTRAINT `phase_checklists_projectId_projects_id_fk` FOREIGN KEY (`projectId`) REFERENCES `projects`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `project_deliverables` ADD CONSTRAINT `project_deliverables_projectId_projects_id_fk` FOREIGN KEY (`projectId`) REFERENCES `projects`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `projects` ADD CONSTRAINT `projects_leadId_leads_id_fk` FOREIGN KEY (`leadId`) REFERENCES `leads`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `site_enterprises` ADD CONSTRAINT `site_enterprises_siteId_construction_sites_id_fk` FOREIGN KEY (`siteId`) REFERENCES `construction_sites`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `site_enterprises` ADD CONSTRAINT `site_enterprises_enterpriseId_enterprises_id_fk` FOREIGN KEY (`enterpriseId`) REFERENCES `enterprises`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
